                ...
                <form>
                        ...
                        <table className="table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    <td><b>First</b></td>
                                    <td>
                                        <input className="form-control" type="text" value={this.state.first_name} name="first_name" onChange={this.handleChange} />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td><b>Last</b></td>
                                    <td>
                                        <input type="text" className="form-control" value={this.state.last_name} name="last_name" onChange={this.handleChange} />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td><b>Status</b></td>
                                    <td>
                                        <input type="text" className="form-control" value={this.state.status} name="status" onChange={this.handleChange} />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td><b>Roles</b></td>
                                    <td>
                                        <input type="text" className="form-control" value={this.state.roles} name="roles" onChange={this.handleChange} />
                                    </td>
                                </tr>
                    ...
                    <div className="col-sm-12 col-md-12 " style={{ marginTop: '50px', marginLeft: '300px' }} >
                        ...
                        <table className="table-bordered"><tbody>
                            <tr><th><b>Id</b></th><th><b>Username</b></th><th><b>First</b></th><th><b>Last</b></th><th><b>Email</b></th><th><b>Status</b></th><th><b>Roles</b></th><th><b>Edit</b></th><th><b>Delete</b></th></tr>
